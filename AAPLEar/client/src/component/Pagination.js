...
export default class Pagination {
    ...
    createBody(){
        ...
        let href1 = (this.currentPage === 1) ? '' : `href="#/index?${this.getProp(this.currentPage-1)}`;
        ...
        let href2 = (this.currentPage === this.totalPage) ? '' : `href="#/index?${this.getProp(this.currentPage+1)}"` ;
        let className2 = (this.currentPage === this.totalPage) ? '' : 'class="active"';
    ...
    keypressHandler(e) {
        if (e.which === 13) {
            ...
            if (Object.prototype.toString.call(value).slice(8, -1) !== 'Number') return;
