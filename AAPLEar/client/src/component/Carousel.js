...
export default class Carousel {
  constructor(imgList, parent) {
    ...
    this.conWidth =
      ((parent.offsetWidth / 100) * screen.width) / parent.offsetWidth;
    this.parent = parent;
  ...
  resizeHandler(e) {
    ...
    document.documentElement.style.fontSize =
      (this.parent.offsetWidth / screen.width) * 100 + "px";
  }
  createImgCon(parent) {
  ...
  createBn(parent) {
    for (let i = 0; i < this.bnList.length; i++) {
      ...
      this.bnList[i].addEventListener("click", (e) => {
        this.bnClickHandler(e);
      });
    }
  }
  mouseHandler(e) {
