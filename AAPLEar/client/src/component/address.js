...
export default class Address {
    ...
    createUl1() {
        ...
        for (let i = 0; i < City.length; i++) {
            ...
            li.addEventListener('mouseenter', e => { this.mouseHandler1(e) });
            ul.appendChild(li)
        }
    ...
    createUl2(item) {
        ...
        for (let i = 0; i < item.length; i++) {
            ...
            li.addEventListener('mouseenter', e => { this.mouseHandler2(e, item) });
    ...
    createUl3(item) {
        ...
        for (let i = 0; i < item.length; i++) {
            let li = Utils.ce('li', {});
            li.textContent = item[i]['name'];
            li.addEventListener('mouseenter', e => { this.mouseHandler3(e) });
            li.addEventListener('mouseleave', e => { this.mouseHandler3(e) });
            li.addEventListener('click', e => { this.clickHandler(e) });
    ...
    clickHandler(e) {
        ...
        localStorage.address = JSON.stringify('送货地址为：' + this.procince+this.city+this.town);
    }
    getAddress(){
