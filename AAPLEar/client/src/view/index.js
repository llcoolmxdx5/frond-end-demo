...
export default class Index{
    ...
    createItemTitle(){
        ...
        divLeft.addEventListener('click', e => {
            ...
            let divArr = document.querySelectorAll('#body > div > div > div.right  div.div1 > a > div.div2');
    ...
    createBody(){
        ...
        this.item.forEach(item => {
            ...
            img1.src = '/src/assets/img/img-' + item.productImages.items[0].src.slice(6,);
            let div4 = document.createElement('div');
            div4.className = 'div4';
            let divTip = document.createElement('div');
            divTip.className = 'tip';
            let span1 = document.createElement('span');
            span1.textContent = item.violatorTranslatedText ? item.violatorTranslatedText : ' ';
