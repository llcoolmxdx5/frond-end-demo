      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                $("#search-slide").html(_views_Search_Search_html__WEBPACK_IMPORTED_MODULE_4___default.a); // await this.getlist()
...
module.exports = "<div id=\"search\">    <div class=\"linputer none\">        <div class=\"lbutton\">            <span class=\"city\">全国</span>            <span class=\"cityicon\"></span>        </div>        <div class=\"rinput\">            <input type=\"text\" class=\"inputer\" placeholder=\"搜索职位或公司\">            <span><i>&#xe501;</i></span>           </div>    </div>    <div class=\"listcon none\">        <div class=\"custominfo none\">将搜索地区和关键词设为定制条件</div>        <div id=\"list-container\">        </div>    </div>    <div class=\"city\">        <div class=\"back\">            <button><</button>        </div>        <div class=\"city-header\">热门城市</div>        <div class=\"city-list\"></div>    </div></div>"
